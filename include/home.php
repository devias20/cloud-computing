<div class="page-header" >
    <h1>BLOG DEVI ASMARANI</h1>
    <h2> Selamat Datang di Blog Devi Asmarani</h2>
...
$query = mysqli_query($koneksi, "SELECT *, RIGHT(berita.isi, 200) as isi_pendek FROM berita INNER JOIN kategori ON berita.id_kategori = kategori.id_kategori 
